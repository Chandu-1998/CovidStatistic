...
const mongoURI =
"mongodb+srv://ChanduSai:Csbh@2525@cluster0.qsq7jhv.mongodb.net/?retryWrites=true&w=majority";
...
const tallySchema = new Schema({
  ...
  const CovidStatistic = mongoose.model("CovidStatistic", tallySchema);
  CovidStatistic.insertMany(data)
  ...
  app.get('/hotspotStates', async (req, res) => {
    const result = await CovidStatistic.aggregate([
